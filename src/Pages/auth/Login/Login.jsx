            ...
            <div className="flex flex-col gap-y-4">
              ...
              <form action="" onSubmit={formik.handleSubmit}>
                ...
                <div className="flex items-center gap-x-[87px] mt-[30px]">
                  <button
                    type="submit"
                    className="py-4 px-[48px] bg-accentRed font-popins font-medium text-white_FFFFFF text-[16px] rounded"
                  >
                    Log In
                  </button>
                  <Link
                    to="/forgotpassword"
                    className="text-accentRed font-popins font-medium  text-[16px] cursor-pointer"
                  >
                    Forget Password?
                  </Link>
                </div>
